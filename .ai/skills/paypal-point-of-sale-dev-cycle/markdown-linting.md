...
markdownlint modules.local/paypal-pos-sync/*.md
```
...
markdownlint /absolute/path/to/README.md
```
...
- Module documentation should be clear and concise
- Use proper brand names: PayPal Point of Sale (not iZettle or Zettle)
