---
name: paypal-pos-markdown
description: Guidelines for creating and modifying markdown files in PayPal Point of Sale. Use when writing documentation, README files, or any markdown content.
---

# PayPal Point of Sale Markdown Guidelines

This skill provides guidance for creating and editing markdown files in the PayPal Point of Sale project.
...
4. **Follow project markdown standards** - See configuration rules below

## PayPal POS Markdown Configuration
...
```markdown
Use the `sync_product()` method to handle product synchronization.
The `$product_id` parameter must be an integer.
```
...
- Reference DDEV setup for local development

### Module Documentation

- Each module should document its purpose
- Include service definitions and their purposes
...
- Documentation should reference PayPal Point of Sale (not iZettle or Zettle)
- Use correct company attribution: Syde (formerly Inpsyde)
- Include PHP 8.2+ requirement where relevant
- Reference DDEV for local development setup
- Module documentation should explain service definitions
- Hook documentation should use `paypal_pos_` prefix
...
- See `paypal-pos-dev-cycle` skill for markdown linting commands
